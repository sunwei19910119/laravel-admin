            ...
            <div class="col-md-12">
                <div class="box box-success">
                    <div class="box-body" style="display: block;">
                        <form method="POST" id="form" action="{{ url('/admin/admin_user') }}" class="form-horizontal" accept-charset="UTF-8" pjax-container="">
                            ...
                            <div class="box-footer">
                                <button type="button" class="btn btn-cancel pull-left" onclick="location='{{ url("/admin/admin_user") }}';">返回</button>
                                <button type="submit" class="btn btn-info pull-right _submit_" data-form-id="form"
                                        data-refresh-url="{{ url("/admin/admin_user") }}">提交</button>
                            </div>
                        </form>
                    </div><!-- /.box-body -->
                </div>
