...
@section('css')
    ...
    {{--<link rel="stylesheet" href="{{ asset('/plugins/iconpicker/icon-picker.min.css') }}">--}}
    <link rel="stylesheet" href="{{ asset('/plugins/iconpicker/bootstrap-iconpicker.min.css') }}">
    <style>
            ...
            <div class="col-md-12">
                <div class="box box-info">
                    ...
                    <div class="box-body" style="display: block;">
                        <form method="POST" id="form" action="{{ url('/admin/menu') }}" class="form-horizontal" accept-charset="UTF-8" pjax-container="">
                            ...
                            <div class="box-footer">
                                ...
                                <div class="col-sm-4">
                                    <div class="btn-group pull-right">
                                        <button type="submit" class="btn btn-info pull-right _submit_" data-form-id="form" data-refresh-url="{{ url('/admin/menu') }}">保存</button>
                                    </div>
                                </div>
...
@section('js')
    ...
    <!--<script src="{{ asset('/plugins/iconpicker/iconPicker.min.js') }}"></script>-->
    <script src="{{ asset('/plugins/iconpicker/iconset-fontawesome-4.2.0.min.js') }}"></script>
    <script src="{{ asset('/plugins/iconpicker/bootstrap-iconpicker.min.js') }}"></script>
    <!-- <script src="{{ asset('/plugins/iconpicker/iconset-glyphicon.min.js') }}"></script> -->
