            ...
            <div class="col-md-5">
                <div class="box box-info">
                    ...
                    <div class="box-body" style="display: block;">
                        <form method="POST" id="form" action="/admin/menu" class="form-horizontal" accept-charset="UTF-8" pjax-container="">
                            <div class="box-body">
                            ...
                            <div class="box-footer">
                                ...
                                <div class="col-sm-4">
                                    <div class="btn-group pull-right">
                                        <button type="submit" class="btn btn-info pull-right _submit_" data-form-id="form" data-url="{{ url('/admin/menu') }}">保存</button>
                                    </div>
                                </div>
    ...
    <script data-exec-on-popstate>
        $(function () {
            ...
            $('.menu-tree-save').click(function () {
                ...
                $.post('{{ url('/admin/menu/tree') }}', {'tree':JSON.stringify(serialize)}, function(data){
                    alert(data.msg);
                    location.reload();
                });
            });
