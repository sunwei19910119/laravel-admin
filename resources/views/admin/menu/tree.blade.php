<li class="dd-item" data-id="<?php echo $branch['id'] ?>">
    <div class="dd-handle">
        ...
        <span class="pull-right action dd-nodrag" data-field-name="_edit">
            ...
            @endforeach
            @endif
            <a href="{{ url('/admin/menu/'.$branch['id'].'/edit') }}"><i class="fa fa-edit"></i></a>
            <a href="javascript:void(0);" data-url="{{ url('/admin/menu/'.$branch['id']) }}" class="_delete_"><i class="fa fa-trash"></i></a>
        </span>
    </div>
    @if(isset($branch['children']))
    <ol class="dd-list">
