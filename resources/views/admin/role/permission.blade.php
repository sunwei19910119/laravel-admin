...
@section('content')
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <form id="form" action="{{ url("/admin/role/" . $role['id'] . "/permission") }}" method="post">
                    <div class="box box-success">
                        ...
                        <div class="box-footer">
                            <button type="button" class="btn btn-info pull-right _submit_" data-refresh-url="{{ url('/admin/role')}}" data-form-id="form">保存</button>
                        </div>
                    </div>
                </form>
                <!-- /.box -->
